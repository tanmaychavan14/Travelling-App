...
const Signupin = ({ onClose, setIsLoggedIn }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post('https://travelling-dvog7gza0-tanmaychavan14s-projects.vercel.app//login', loginData, { withCredentials: true });
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      const response = await axios.post('https://travelling-dvog7gza0-tanmaychavan14s-projects.vercel.app/registration', registrationData);
